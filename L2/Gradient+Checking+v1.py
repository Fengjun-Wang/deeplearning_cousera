...
def gradient_check(x, theta, epsilon = 1e-7):
    ...
    ### START CODE HERE ### (approx. 1 line) #TODO: check why ord must be None (default 2 -norm)
    numerator = np.linalg.norm(grad - gradapprox, ord=None)                               # Step 1'
    denominator = np.linalg.norm(grad, ord=None) + np.linalg.norm(gradapprox, ord=None)                             # Step 2'
